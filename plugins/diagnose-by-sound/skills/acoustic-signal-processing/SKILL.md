...
5. **Probe physically** when the area is known: mechanic's stethoscope on bearings and
   ...
   rotating: no hands, tools, clothing or hair near belts, fans, pulleys or driveshafts
   while anything is moving; engine off before reaching in; road tests with one person
   driving and another listening, never both jobs at once.
